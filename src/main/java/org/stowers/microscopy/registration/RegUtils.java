...
public class RegUtils {
    ...
    public static double[][] getLocalTransform(ImagePlus target, ImagePlus imp, int width, int height, int transformation, int f){
    ...
    public static double[][] getLocalTransform(ImagePlus imp,int width,int height,int transformation,int f,int prevf){
        double[][] sourcePoints = null;
        double[][] targetPoints = null;
        double[][] localTransform = null;
